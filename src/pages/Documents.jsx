    ...
    <div className="bg-cream min-h-screen">
      <div className="max-w-7xl mx-auto px-4 pt-32 pb-24 space-y-16">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-5xl mx-auto bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-primary/10"
        >
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-primary text-white">
                  <th className="px-8 py-6 text-sm font-bold uppercase tracking-widest">Document Name</th>
                  <th className="px-8 py-6 text-sm font-bold uppercase tracking-widest text-center">Action</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-primary/10">
                  ...
                  >
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                          <span className="text-brand-dark font-bold md:text-lg">{doc.name}</span>
                          <span className="text-[10px] text-primary font-bold uppercase tracking-widest bg-primary/10 px-2 py-0.5 rounded-full w-fit mt-1">Foundational Document</span>
                        </div>
                      </div>
                    </td>
                    <td className="px-8 py-6 text-center">
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-primary text-white text-sm font-bold hover:bg-primary-dark transition-all hover:shadow-lg active:scale-95 group/btn"
                      >
                ...
                {documents.map((doc, idx) => (
                  ...
                  >
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-4">
                        <div className="p-3 bg-primary/5 rounded-xl group-hover:bg-primary/10 transition-colors relative">
                          <FileText className="text-primary" size={24} />
                        </div>
                        <div className="flex flex-col">
                          <span className="text-brand-dark font-medium md:text-lg">{doc}</span>
                        </div>
                      </div>
                    </td>
                    <td className="px-8 py-6 text-center">
