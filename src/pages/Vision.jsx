        ...
        <section className="space-y-16">
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              className="text-left"
            >
              <h2 className="text-3xl md:text-5xl font-serif text-brand-title mb-4">{t('about_page.vision.title')}</h2>
              <div className="w-32 h-1 bg-gradient-to-r from-transparent via-primary to-transparent mb-8"></div>
            </motion.div>
          </div>

          <div className="flex flex-col lg:flex-row gap-16 items-start md:w-full lg:max-w-4xl mx-auto">
            {/* Left Column: Sticky Diagram */}
            <div className="lg:sticky lg:top-40 lg:w-full lg:max-w-[768px]">
              <motion.div
